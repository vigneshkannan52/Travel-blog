...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Explore_Blog_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	...
	class Explore_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Explore_Blog_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'explore-blog-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="explore_blog_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
